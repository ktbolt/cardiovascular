...
if __name__ == '__main__':
    ...
    file_dir = "/Users/parkerda/SimVascular/CylinderProject/Meshes/solid-mesh-complete/mesh-surfaces/"
    interface_surf = SurfaceMesh(file_dir+"interface.vtp")
    actor = add_geom(interface_surf.mesh, renderer)
    ...
    '''
    file_dir = "/Users/parkerda/SimVascular/CylinderProject/Meshes/fluid-mesh-complete/"
    fluid_interface_surf = SurfaceMesh(file_dir+"mesh-complete.exterior.vtp")
    actor = add_geom(interface_surf.mesh, renderer)
    actor.GetProperty().SetRepresentationToWireframe()
    actor.GetProperty().SetColor(0.8, 0.0, 0.0)
    actor.GetProperty().SetLineWidth(4.0)

    interface_surf.check_points(fluid_interface_surf.num_points, fluid_interface_surf.points, 
        fluid_interface_surf.point_ids, renderer)
    '''

    print(" ")
    file_dir = "/Users/parkerda/SimVascular/CylinderProject/Meshes/fluid-mesh-complete/mesh-surfaces/"
    lumen_wall = SurfaceMesh(file_dir+"lumen_wall.vtp")
    actor = add_geom(lumen_wall.mesh, renderer)
    actor.GetProperty().SetRepresentationToWireframe()
    actor.GetProperty().SetColor(0.8, 0.0, 0.0)
    actor.GetProperty().SetLineWidth(3.0)

    print(" ")
    interface_surf.check_points(lumen_wall.num_points, lumen_wall.points, lumen_wall.point_ids, renderer)
    ...
    # Read the domain 1 files.
    domain_1_dir = sys.argv[2]
    domain_1 = MeshDomain(domain_1_dir)

    # Read the domain 2 files.
    domain_2_dir = sys.argv[3]
    domain_2 = MeshDomain(domain_2_dir)

    # Check domain 1 points.

    print(" ")
    print("Check domain 1 mesh_complete_exterior_vtp points ...")
    volume_mesh.check_points(domain_1.mesh_complete_exterior_vtp.num_points, domain_1.mesh_complete_exterior_vtp.points, 
        domain_1.mesh_complete_exterior_vtp.point_ids, renderer)

    print(" ")
    print("Check domain 1 volume points ...")
    volume_mesh.check_points(domain_1.mesh_complete_mesh_vtu.num_points, domain_1.mesh_complete_mesh_vtu.points, 
        domain_1.mesh_complete_mesh_vtu.point_ids, renderer)
    ...
    print(" ")
    print("Check domain 1 walls_combined_vtp points ...")
    volume_mesh.check_points(domain_1.walls_combined_vtp.num_points, domain_1.walls_combined_vtp.points, 
        domain_1.walls_combined_vtp.point_ids, renderer)

    print(" ")
    print("Check domain 2 volume points ...")
    volume_mesh.check_points(domain_2.mesh_complete_mesh_vtu.num_points, domain_2.mesh_complete_mesh_vtu.points, 
        domain_2.mesh_complete_mesh_vtu.point_ids, renderer)
