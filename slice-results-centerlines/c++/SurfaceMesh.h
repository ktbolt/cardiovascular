...
class SurfaceMesh : public Mesh {
  ...
  public:
    ...
    void SlicePlane(int index, double radius, int cellID, std::string dataName, double pos[3], double normal[3]);
    void UndoSlice();
    void WriteSlices();
  ...
  private:
    ...
    void SliceArea(double radius, vtkPolyData* lines, Slice* slice);
