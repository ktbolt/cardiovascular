...
data_directory = "/home/davep/software/itk/examples/python/data"
out_directory = "/home/davep/software/itk/examples/python/out"
...
'''
direction: ( 1.0131605395355832, -0.7129785712404799, -0.627369136497538, 
             0.8486129051537744, -0.08649484798512744, 0.5218953711985772, 
            -0.4263644141860966, -0.6958305815526605,  0.5779560433907003 )
'''
...
series_tag_values = [(k, series_reader.GetMetaData(0,k)) for k in tags_to_copy if series_reader.HasMetaDataKey(0,k)] + \
                 [("0008|0031",modification_time), # Series Time
                  ...
                  ("0008|0008","DERIVED\\SECONDARY"), # Image Type
                  ("0020|000e", "1.2.826.0.1.3680043.2.1125."+modification_date+".1"+modification_time), # Series Instance UID
                  ("0020|0037", '\\'.join(map(str, (1.0, 0.0, 0.0,# Image Orientation (Patient)
                                                    0.0, 1.0, 0.0)))) ]
